...
### MC-034 — Conduct Anti-Surface Warfare Patrol

```yaml
id: MC-034
name: Conduct Anti-Surface Warfare Patrol
status: draft

mission_family: Naval Combat
mission_type: Offensive Control
operational_intent: Detect, Track and Deter
mission_target: Surface Threat
...
desired_end_state:
  - Patrol area monitored.
  - Surface contacts classified.
  - Hostile units tracked or neutralized.
  - Maritime situational awareness maintained.

success_criteria:
  - Assigned patrol completed.
  - No hostile surface activity remains undetected.
  - Threats reported or neutralized according to ROE.

failure_criteria:
  - Patrol area insufficiently covered.
  - Hostile unit remains undetected.
  - Friendly force surprised by a surface threat.

required_capabilities:
  - SurfaceSurveillanceCapability
  - SurfaceTrackingCapability
  - NavigationCapability
  - CommunicationCapability

optional_capabilities:
  - SurfaceEngagementCapability
  - ElectronicSupportCapability
...
notes: >
  This mission represents continuous ASuW presence and surveillance. Engagement is
  optional and depends on the operational context and Rules of Engagement.
```
...
operational_intent: Defeat
mission_target: Hostile Surface Unit
...
desired_end_state:
  - Hostile surface threat neutralized.
  - Friendly force retains freedom of manoeuvre.
...
### MC-036 — Conduct Anti-Submarine Warfare Patrol

```yaml
id: MC-036
name: Conduct Anti-Submarine Warfare Patrol
status: draft

mission_family: Naval Combat
mission_type: Offensive Control
operational_intent: Detect, Track and Deter
mission_target: Subsurface Threat
...
preconditions:
  - Patrol area defined.
  - ASW assets available.
  - Rules of engagement established.

desired_end_state:
  - Undersea situation established.
  - Hostile submarines tracked or contained.
...
failure_criteria:
  ...
  - Friendly force surprised by an underwater threat.

required_capabilities:
  - UnderwaterDetectionCapability
  - UnderwaterTrackingCapability
  - NavigationCapability
  - CommunicationCapability

optional_capabilities:
  - UnderwaterEngagementCapability
  - ElectronicSupportCapability
...
mission_type: Offensive Action
operational_intent: Defeat
mission_target: Hostile Submarine
...
preconditions:
  ...
  - Engagement authorized.
  - ASW weapon systems available.

desired_end_state:
  - Hostile submarine neutralized.
  - Undersea threat removed.
...
mission_family: Naval Combat
mission_type: Defensive Action
operational_intent: Protect
mission_target: Air Threat
...
desired_end_state:
  - Task group protected.
  - Air threats intercepted or deterred.
  - Air superiority around the task group maintained.

success_criteria:
  - No protected unit lost due to an air threat.
  - Air threats detected and handled in time.

failure_criteria:
  - Air threat penetrates the defensive screen.
  - Protected force suffers unacceptable losses.

required_capabilities:
  - AirSurveillanceCapability
  - AirTrackingCapability
  - AirEngagementCapability
  - CommunicationCapability
...
### MC-039 — Conduct Naval Fire Support
...
### MC-040 — Conduct Precision Strike
...
### MC-041 — Neutralize Time-Sensitive Target
...
### MC-042 — Conduct Demonstration of Force
...
### MC-043 — Conduct Show of Presence
...
### MC-044 — Conduct Amphibious Landing Support
...
### MC-046 — Support Amphibious Maneuver
...
### MC-047 — Conduct Amphibious Withdrawal
...
### MC-048 — Conduct Tactical Replenishment at Sea
...
### MC-049 — Conduct Personnel Recovery
...
### MC-050 — Conduct Non-combatant Evacuation Support
...
### MC-051 — Conduct Humanitarian Assistance Support
...
### MC-052 — Conduct Disaster Relief Support
...
### MC-053 — Conduct Medical Evacuation Support
...
### MC-054 — Conduct Strategic Sealift Support
...
### MC-055 — Conduct Maritime Logistics Support
...
### MC-056 — Conduct Maintenance Support
...
### MC-057 — Conduct Electronic Warfare Support
...
### MC-058 — Conduct Electromagnetic Surveillance
...
### MC-059 — Conduct Information Collection Support
...
### MC-060 — Conduct Communication Relay Support
...
### MC-061 — Conduct Deception Operations
...
### MC-062 — Conduct Cyber Defence Support
...
### MC-063 — Conduct Maritime Interdiction Support
...
### MC-064 — Conduct Visit, Board, Search and Seizure (VBSS)
...
### MC-065 — Conduct Training Support
...
### MC-066 — Conduct Experimentation Support
