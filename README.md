...
- Le **State Model v0.2** est le vocabulaire dynamique dérivé des trois référentiels métier. Sa source YAML est normative pour les états des signatures enrichies.
...
Les référentiels sont encore à des niveaux de maturité différents : l’architecture est une proposition à valider, l’ontologie, les catalogues et le State Model v0.2 sont des brouillons de travail, et DEM-1/DEM-2 sont des spécifications méthodologiques en brouillon. Le Task Catalog v0.9.0 est la version courante : ses 19 signatures enrichies utilisent les identifiants stables du State Model selon DEM-1/DEM-2 v0.6. Les 60 autres signatures restent à traiter progressivement.
