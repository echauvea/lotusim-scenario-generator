...
| **LOTUSim Mission Catalog** | v0.3.1 existante | 66 missions, 9 familles doctrinales, capacités requises par mission |
| **LOTUSim Task Catalog** | v0.3 existante | 64 verbes canoniques, 79 signatures typées, capacités par signature |
...
3. **§10.3 et Annexe D** : statuts des référentiels mis à jour — Naval
   Ontology v2.0-draft, Mission Catalog v0.3.1, Task Catalog v0.3 existent ;
...
- **LOTUSim Mission Catalog** v0.3.1 ;
- **LOTUSim Task Catalog** v0.3.
