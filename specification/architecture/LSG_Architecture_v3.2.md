...
| **LOTUSim Task Catalog** | v0.11.0 existante | 64 verbes canoniques, 79 signatures typées ; 28 signatures alignées sur le State Model |
| **LOTUSim State Model** | v0.4 existant | 86 états dynamiques normatifs, 18 types propres et traçabilité producteurs/consommateurs |
...
3. **§10.3 et Annexe D** : statuts des référentiels mis à jour — Naval
   Ontology v2.0-draft, Mission Catalog v1.0.4, Task Catalog v0.11.0 et State
   Model v0.4 existent ;
...
- **LOTUSim Task Catalog** v0.11.0 ;
- **LOTUSim State Model** v0.4 (`.yaml`).
