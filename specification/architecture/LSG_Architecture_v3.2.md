...
| **LOTUSim Task Catalog** | v0.7.0 existante | 64 verbes canoniques, 79 signatures typées, capacités et Semantic Family par signature |
...
3. **§10.3 et Annexe D** : statuts des référentiels mis à jour — Naval
   Ontology v2.0-draft, Mission Catalog v1.0.4, Task Catalog v0.7.0 existent ;
